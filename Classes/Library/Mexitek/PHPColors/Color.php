...
namespace PackageFactory\ColorHelper\Library\Mexitek\PHPColors;

/**
 * NOTE; This class is copied as the origial repository has not seen a release in years
 * but a bugfix is needed that was only present in master.
 */
use \Exception;
...
class Color {
    ...
    private static function _checkHex( $hex ) {
        ...
        if( strlen($color) == 3 ) {
            ...
            throw new Exception("HEX color needs to be 6 or 3 digits long ::" . $color . "::" );
        }
